...
- **🧠 Adaptive AI Engine:** Dynamically increases or decreases question difficulty based on user responses (FR-06).
- **🎙️ Speaking & Writing Analysis:** Uses advanced AI models to grade pronunciation, fluency, and essay structure (FR-14, FR-15).
- **📊 Integrated Dashboard:** Visualizes progress with detailed charts and CEFR progression metrics (FR-12).
- **💡 Smart Hints:** Provides context-aware hints without revealing answers during exams (UC-06).
- **📅 Personalized Study Plans:** Generates tailored learning roadmaps based on weak areas (UC-18).
- **🛡️ Admin Panel:** Complete system monitoring and user management for administrators (UC-22).
